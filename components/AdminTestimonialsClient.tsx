...
export default function AdminTestimonialsPage({ initialTestimonials }: AdminTestimonialsClientProps) {
                  ...
                  <div className="flex flex-col gap-2">
                    {!testimonial.isApproved ? (
                      ...
                      <button
                        ...
                        disabled={isProcessing === testimonial.id}
                        className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:opacity-50 cursor-pointer"
                      >
                    ...
                    <button
                      ...
                      disabled={isProcessing === testimonial.id}
                      className="rounded-lg border border-red-300 bg-white px-4 py-2 text-xs font-semibold text-red-700 transition hover:bg-red-50 disabled:opacity-50 cursor-pointer"
                    >
                      削除
                    </button>
                  </div>
